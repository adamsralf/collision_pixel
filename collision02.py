"""Detecting exact sprite collision with PyGame.

A short program which shows how collision detection works with PyGame. 
This collision detection checks wether on the same position of the 
intersection of sprites the mask bit is set or not. 
"""
import pygame
...
#pylint: enable=no-member
    ...
    while running:
        ...
        for bird in all_warbirds:
            t = pygame.sprite.collide_mask(fire, bird)  # HERE!
            if t:
